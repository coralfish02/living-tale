...
**デモ動画**: https://www.youtube.com/watch?v=cjcSM7bUdVs
...
Living Taleのアプローチは、普通のAIチャットとは根本的に違います：
...
> **たとえ:** 普通のAI = 1人の作家に「全部書いて」と頼む / Living Tale = **語り手（AI）が全体を見渡して舞台を描き、役者（キャラクターAI）が自分の立場だけで本音を返す「二重構造の劇」**
