---
title: "【Gemini 2.0 Flash × マルチエージェント】キャラクターが勝手に動き出す物語生成AI「Living Tale」を作った"
emoji: "📖"
type: "tech"
topics: ["GoogleCloud", "Gemini", "AI", "Python", "ハッカソン"]
published: false
---

## 🎬 はじめに：創作の「孤独」と「予定調和」を壊す

こんにちは！**Google Cloud Japan AI Hackathon Vol.4** に参加した、チーム「Echo」です。
...
:::message
🌐 **デモURL**: https://project-echo-192671776924.us-central1.run.app
📦 **リポジトリ**: https://github.com/mukai-boop/project-echo
:::

### Living TaleのUI

![Living Tale メイン画面 — キャラクター生成・起承転結の進行・AIからの提案チップが一画面に集約されている](/images/living-tale-ui.png)
...
### 日本のクリエイティブ産業が抱える「設計フェーズ」の課題

長年、日本はサブカル領域における世界の第一線をリードしてきました。漫画家やアニメ作家、ライトノベル小説家といった数多くのクリエイター達が、魅力的なキャラクターと物語を生み出し続けてきたからです。

一方で、**創作のボトルネックは「書くこと」そのものではなく、キャラクターがどう動くかを設計し、物語の骨格を立ち上げる工程にあります**。この土台が弱いと、台詞や演出を磨いても会話が空回りし、展開は予定調和に寄ってしまいます。

この工程が重い理由は明確です。頭の中で「このキャラなら次に何をするか」を何度もシミュレートし、組み合わせを探索し続ける必要がある。キャラクターや制約が増えるほど探索空間は膨らみ、**時間が溶けてしまう**のです。
...
![AIからの提案チップのUI](/images/living-tale-ui.png)
...
🌐 https://project-echo-192671776924.us-central1.run.app

最後まで読んでいただきありがとうございました！
質問やフィードバックは、ぜひ [GitHub](https://github.com/mukai-boop/project-echo) のIssueまでお寄せください。

---

**チーム Echo** | Google Cloud Japan AI Hackathon Vol.4 参加作品
