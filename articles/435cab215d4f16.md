...
> 「もし、キャラクターたちが作者の知らない本音を抱え、その裏の思惑がぶつかり合って予想外のドラマが生まれたら？」
...
- 🎭 **キャラクターの内面は独立したエージェントが生成し、物語全体は語り手エージェントが統括する**——各キャラクターの内心は自身の性格・目的だけをもとに生成されるため、表の行動と裏の本音にズレが自然に生まれる
...
テーマを1行入力するだけで、キャラクターたちが作者の知らない本音を抱え、その裏の思惑がぶつかり合って予想外のドラマが生まれます。ぜひ一度、体験してみてください。
